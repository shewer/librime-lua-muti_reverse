...
local user_table= {}
local user_func={} 
function user_func.quick_code(text)
    local str=""
...
function user_func.terra_pinyin_func(inp)
...
-- 副反查
local comment_tab=require("muti_reverse.comment_tab")
...
local function get_comment(str )
    --  以 str 調出  revdb  
